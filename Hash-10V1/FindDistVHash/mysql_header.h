...
{"int", "varchar (20000)","double","double","double","double","double","double","double","double","double","double"},
//{"int", "varchar (20000)"},                                     // Primeira Tabela : VECTORS
{"int","varchar(15)", "varchar(511)"}
};	

const char* tcol_ins[][12]  = {
{"int", "varchar","double", "double", "double", "double","double","double","double","double","double","double"},    // Primeira Tabela : VECTORS
//{"int", "varchar"},
{"int", "varchar", "varchar"}                                   // Segunda Tabela : TABIMG
};

const char* ncol[][12] = {
{"Id", "Coord","H1", "H2", "H3","H4","H5","H6", "H7","H8","H9","H10"},                          // Primeira Tabela : VECTORS
//{"Id", "Coord"},
