...
if($conta)
 ...
 ?>
		...
		<!-- Colocando a imagem !-->
		<a target="_blank" href= "<?php echo "builtIn/mostraImagem.php?imgName=" . $img['Nome'] . ".jpg&pesquisa='" . $_SESSION['texto'] . "'"; ?>" > <img alt="Imagem sem thumbnail" src="<?php echo "builtIn/upload/fmt/cmp250/" . $img['Nome'] . ".jpg"; ?>" alt="<?php echo $img['Nome']; ?>"  /> </a>
		</div>
